...
//   //res.send("Admin login route working");
//   const sql = "select * from admins where email=? and password=?";
//   conn.query(sql, [req.body.email, req.body.password], (result, err) => {
//     if (err) {
//       return res.json({
//         loginStatus: "false",
//         err: "email and password not provided",
//       });
//     }
//     if (result.length > 0) {
//       const email = result[0].email;
//       const token = jwt.sign({ role: "user" }, "jwt-secret-key", {
//         expiresIn: "1d",
//       });
...
//       });
//     }
//     else return res.json({loginStatus:'false',err:"Wrong Credentails"})
//   });
// });
